...
#
# Script generated by Vivado on Tue Mar 31 14:49:26 +0800 2026
...
# script info
echo -e "top.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot  xil_defaultlib. xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/AMDstuff/2025.2/Vivado/data/xsim"
  fi
